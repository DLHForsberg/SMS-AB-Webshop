...
<h1>Reservdelar</h1>
<p>Här finns vårt utbud av reservdelar till helikoptrar.</p>
...
AND M_Product.M_Product_Category_ID='DCDA18004502440BAC08A2C965CD7658'");
...
echo "</tr>";
echo "<tr>";
echo "<td colspan='2'>Antal i lager: $row[4]</td>";
echo "</tr>";
echo "<tr>";
...
WHERE M_Product.M_Product_ID=M_ProductPrice.M_Product_ID 
AND M_ProductPrice.M_PriceList_Version_ID='CB6B235A5EB44D87B95D69584AB0552E'
AND M_Product.M_Product_Category_ID='F265558961B9471482429E186D053369'");
