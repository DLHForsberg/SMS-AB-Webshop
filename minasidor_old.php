...
class Settings
{
	public static $servername = "mysql:dbname=isuprojekt;host=cbserver.iit.his.se";
	public static $username = "sqllab";
	public static $password = "Tomten2009";
}
...
<div class="up">  
		...
		<nav class="nav_up">
			  ...
			  <a href="kundkorg.html"> Kundkorg</a>
...
</nav></div></div><form action="search.php"  method="post">
			  <span><input type="text"  name="produkt" ass="search rounded" placeholder="Search..."></span>

			  </form>
<div class="header">
<a href="index.html"><h1>SMS AB</h1></a>
</div>

<div class="row">
<div class="col-3 col-m-3 menu">
<ul>
<li class=""><a href="index.html">Hem</a></li>
<li>Modeller
<ul>
<li class="item"><a href="helikoptrar.php">Helikoptrar</a></li>
...
<ul>
<li class="item"><a href="accesoarer.php">Accesoarer</a></li>
<li class="item"><a href="reservdelar.php">Reservdelar</a></li>
</li>
</ul>
...
<div id="innehall" class="col-6 col-m-6">
	...
	<div class="pageField">
		...
		<p style="font-style: italic;">Du har inga tidigare beställningar</p>
	</div>
	...
	<div class="pageField">	
		...
		<div class="form_description">
			<h2>Uppgifter</h2>
			<p>ändra mina uppgifter woop woop</p>
		</div>';
		...
		if(isset($_POST['submit'])){
			if($_POST['submit'] == "Uppdatera"){
				...
				updatePasswordData($_SESSION['userid']); //�ndra l�sen
			}
